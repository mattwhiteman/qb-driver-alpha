...
/**
 * AbmcGeneralJournalHeader generated by hbm2java
 */
@Entity
@Table(name = "abmc_general_journal_header")
public class AbmcGeneralJournalHeader implements java.io.Serializable {
	...
	private String memo;
	private byte isFiledTxnBool;
	private short lastAuditableAction;
	private byte isSdkAppBool;
	private Integer olbTxnId;
	private Integer currencyId;
	private double exchangeRate;
	private byte isHomeCurrencyAdjustmentBool;
	private byte isShownInHomeCurrencyBool;
	private byte hasAttachmentsBool;
	private String externalIdent;
	private String stickyNote;

	public AbmcGeneralJournalHeader() {
	}

	public AbmcGeneralJournalHeader(int transactionId, int targetId, byte isNoPostBool, byte isMemorizedTransactionBool,
			byte isCondensedBool, String abmId, byte isAlwaysTrackBool, Date dbCreatedTms, Date dbModifiedTms,
			byte isFiledTxnBool, short lastAuditableAction, byte isSdkAppBool, double exchangeRate,
			byte isHomeCurrencyAdjustmentBool, byte isShownInHomeCurrencyBool, byte hasAttachmentsBool) {
		...
		this.isFiledTxnBool = isFiledTxnBool;
		this.lastAuditableAction = lastAuditableAction;
		this.isSdkAppBool = isSdkAppBool;
		this.exchangeRate = exchangeRate;
		this.isHomeCurrencyAdjustmentBool = isHomeCurrencyAdjustmentBool;
		this.isShownInHomeCurrencyBool = isShownInHomeCurrencyBool;
		this.hasAttachmentsBool = hasAttachmentsBool;
	}

	public AbmcGeneralJournalHeader(int transactionId, int targetId, Date transactionDate, Integer customerId,
			Integer vendorId, Integer employeeId, Integer otherId, byte isNoPostBool, byte isMemorizedTransactionBool,
			Integer writeCount, Integer timestampTms, Integer modtimestampTms, Integer transNum, Integer lastEditBy,
			byte isCondensedBool, Short transactionNameType, String docNum, String docNumNumericpart, String abmId,
			byte isAlwaysTrackBool, Date dbCreatedTms, Date dbModifiedTms, Integer companyId, String memo,
			byte isFiledTxnBool, short lastAuditableAction, byte isSdkAppBool, Integer olbTxnId, Integer currencyId,
			double exchangeRate, byte isHomeCurrencyAdjustmentBool, byte isShownInHomeCurrencyBool,
			byte hasAttachmentsBool, String externalIdent, String stickyNote) {
		this.transactionId = transactionId;
		this.targetId = targetId;
	...
	@Column(name = "is_filed_txn_bool", nullable = false)
	public byte getIsFiledTxnBool() {
		return this.isFiledTxnBool;
	}

	public void setIsFiledTxnBool(byte isFiledTxnBool) {
		this.isFiledTxnBool = isFiledTxnBool;
	}
	...
	@Column(name = "is_home_currency_adjustment_bool", nullable = false)
	public byte getIsHomeCurrencyAdjustmentBool() {
		return this.isHomeCurrencyAdjustmentBool;
	}

	public void setIsHomeCurrencyAdjustmentBool(byte isHomeCurrencyAdjustmentBool) {
		this.isHomeCurrencyAdjustmentBool = isHomeCurrencyAdjustmentBool;
	}

	@Column(name = "is_shown_in_home_currency_bool", nullable = false)
	public byte getIsShownInHomeCurrencyBool() {
		return this.isShownInHomeCurrencyBool;
	}

	public void setIsShownInHomeCurrencyBool(byte isShownInHomeCurrencyBool) {
		this.isShownInHomeCurrencyBool = isShownInHomeCurrencyBool;
	}
