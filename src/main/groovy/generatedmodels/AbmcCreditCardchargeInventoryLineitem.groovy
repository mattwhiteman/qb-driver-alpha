...
/**
 * AbmcCreditCardchargeInventoryLineitem generated by hbm2java
 */
@Entity
@Table(name = "abmc_credit_cardcharge_inventory_lineitem")
public class AbmcCreditCardchargeInventoryLineitem implements java.io.Serializable {
	...
	public AbmcCreditCardchargeInventoryLineitem() {
	}

	public AbmcCreditCardchargeInventoryLineitem(int inventoryRecordId, int targetType, int targetId, String abmId,
	...
	public AbmcCreditCardchargeInventoryLineitem(int inventoryRecordId, int targetType, int targetId,
