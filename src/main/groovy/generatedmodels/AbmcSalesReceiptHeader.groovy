...
/**
 * AbmcSalesReceiptHeader generated by hbm2java
 */
@Entity
@Table(name = "abmc_sales_receipt_header")
public class AbmcSalesReceiptHeader implements java.io.Serializable {
	...
	public AbmcSalesReceiptHeader() {
	}

	public AbmcSalesReceiptHeader(int transactionId, int targetId, String abmId, byte isNoPostBool,
			byte isMemorizedTransactionBool, byte isSaleBool, byte isToBePrintedBool, byte isToBeSentBool,
			byte isSplitBool, byte isOldTranTaxBool, byte isAlwaysTrackBool, Date dbCreatedTms, Date dbModifiedTms,
	...
	public AbmcSalesReceiptHeader(int transactionId, int targetId, Date transactionDate, Integer customerId,
			String abmId, String contactId, Integer salesRepId, Integer salesTaxCodeId, String shipToId,
			Integer shipViaId, Integer paymentMethodId, Integer customStyleId, Integer customerMessageId,
			Date latestLinkDate, Integer writeCount, Integer timestampTms, Integer modtimestampTms, Integer transNum,
			String docNum, String docNumNumericpart, Integer lastEditBy, byte isNoPostBool,
			byte isMemorizedTransactionBool, byte isSaleBool, byte isToBePrintedBool, byte isToBeSentBool,
			byte isSplitBool, byte isOldTranTaxBool, Short clearedType, Date shipDate, String fob, String poNum,
			String other, Date deliveryDate, byte isAlwaysTrackBool, Date dbCreatedTms, Date dbModifiedTms,
			Integer companyId, String memo, byte isAmtInclTaxBool, String companyTaxNumber, short lastAuditableAction,
			byte isSdkAppBool, Integer olbTxnId, String origin, Integer currencyId, double exchangeRate,
