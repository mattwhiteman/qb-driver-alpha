...
/**
 * EsEmployeeHrCompHistId generated by hbm2java
 */
@Embeddable
public class EsEmployeeHrCompHistId implements java.io.Serializable {

	private String employeeAbmId;
	private int position;

	public EsEmployeeHrCompHistId() {
	}

	public EsEmployeeHrCompHistId(String employeeAbmId, int position) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EsEmployeeHrCompHistId))
			return false;
		EsEmployeeHrCompHistId castOther = (EsEmployeeHrCompHistId) other;
