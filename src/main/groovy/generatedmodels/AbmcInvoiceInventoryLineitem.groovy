...
/**
 * AbmcInvoiceInventoryLineitem generated by hbm2java
 */
@Entity
@Table(name = "abmc_invoice_inventory_lineitem")
public class AbmcInvoiceInventoryLineitem implements java.io.Serializable {
	...
	public AbmcInvoiceInventoryLineitem() {
	}

	public AbmcInvoiceInventoryLineitem(int inventoryRecordId, int targetType, int targetId, String abmId,
	...
	public AbmcInvoiceInventoryLineitem(int inventoryRecordId, int targetType, int targetId,
