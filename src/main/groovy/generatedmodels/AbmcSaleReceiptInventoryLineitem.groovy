...
/**
 * AbmcSaleReceiptInventoryLineitem generated by hbm2java
 */
@Entity
@Table(name = "abmc_sale_receipt_inventory_lineitem")
public class AbmcSaleReceiptInventoryLineitem implements java.io.Serializable {
	...
	public AbmcSaleReceiptInventoryLineitem() {
	}

	public AbmcSaleReceiptInventoryLineitem(int inventoryRecordId, int targetType, int targetId, String abmId,
	...
	public AbmcSaleReceiptInventoryLineitem(int inventoryRecordId, int targetType, int targetId,
