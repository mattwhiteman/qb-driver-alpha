...
/**
 * AbmcCheckLineitem generated by hbm2java
 */
@Entity
@Table(name = "abmc_check_lineitem")
public class AbmcCheckLineitem implements java.io.Serializable {
	...
	public AbmcCheckLineitem() {
	}

	public AbmcCheckLineitem(int targetId, int transactionId, byte isSourceBool, byte isNoPostBool,
			...
			byte isDiscountBool, byte isInvoicedBool, byte isManuallyClosedBool, byte isReceivedBool,
			byte isGroupendRowBool, byte isDontPrintTargetBool, String abmId, Date dbCreatedTms, Date dbModifiedTms,
			byte isTransTaxBool, double exchangeRate, byte isGainLossTargetBool) {
	...
	public AbmcCheckLineitem(int targetId, int transactionId, Integer accountId, Date transactionDate,
			...
			BigDecimal unitPriceQnty, byte isManuallyClosedBool, byte isReceivedBool, byte isGroupendRowBool,
			byte isDontPrintTargetBool, Short bankAccountType, String bankRefName, String bankRoutingNum,
			String bankAccountNum, String abmId, Date dbCreatedTms, Date dbModifiedTms, String memo,
			BigDecimal netAmountAmt, BigDecimal grossAmountAmt, BigDecimal taxAmountAmt, BigDecimal taxableAmountAmt,
			Date filedDate, Integer taxCodeId, BigDecimal grossUnitPriceAmt, BigDecimal grossUnitPriceQnty,
			BigDecimal grossUnitPricePct, byte isTransTaxBool, Integer siteId, Integer unitId, Integer currencyId,
			double exchangeRate, BigDecimal foreignAmountAmt, byte isGainLossTargetBool, String epaymentTxnIdent,
			Short paymentEntryType, BigDecimal derivedOnHandQnty, BigDecimal taxableAmountQnty,
			BigDecimal netOpenBalanceAmt, BigDecimal taxOpenBalanceAmt, BigDecimal grossOpenBalanceAmt, Integer rsbId,
			Integer txnLineOrder, Integer salesRepId, String manufacturerPartNum) {
		this.targetId = targetId;
		this.transactionId = transactionId;
