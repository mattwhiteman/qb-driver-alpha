...
/**
 * AbmcInventoryAdjustInventoryLineitem generated by hbm2java
 */
@Entity
@Table(name = "abmc_inventory_adjust_inventory_lineitem")
public class AbmcInventoryAdjustInventoryLineitem implements java.io.Serializable {
	...
	public AbmcInventoryAdjustInventoryLineitem() {
	}

	public AbmcInventoryAdjustInventoryLineitem(int inventoryRecordId, int targetType, int targetId, String abmId,
	...
	public AbmcInventoryAdjustInventoryLineitem(int inventoryRecordId, int targetType, int targetId,
