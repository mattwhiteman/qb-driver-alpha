...
/**
 * EsEmployeePayrollItemId generated by hbm2java
 */
@Embeddable
public class EsEmployeePayrollItemId implements java.io.Serializable {

	private String employeeAbmId;
	private int position;

	public EsEmployeePayrollItemId() {
	}

	public EsEmployeePayrollItemId(String employeeAbmId, int position) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EsEmployeePayrollItemId))
			return false;
		EsEmployeePayrollItemId castOther = (EsEmployeePayrollItemId) other;
