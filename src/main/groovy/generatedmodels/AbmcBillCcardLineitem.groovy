...
/**
 * AbmcBillCcardLineitem generated by hbm2java
 */
@Entity
@Table(name = "abmc_bill_ccard_lineitem")
public class AbmcBillCcardLineitem implements java.io.Serializable {
	...
	public AbmcBillCcardLineitem() {
	}

	public AbmcBillCcardLineitem(int targetId, int transactionId, byte isSourceBool, byte isNoPostBool,
	...
	public AbmcBillCcardLineitem(int targetId, int transactionId, Integer accountId, Date transactionDate,
			...
			String contactId, Integer siblingAccountId, Integer paymentMethodId, Date latestLinkDate,
			...
			BigDecimal foreignAmountAmt, byte isGainLossTargetBool, BigDecimal netOpenBalanceAmt,
