...
/**
 * AbmcSalesOrderHeader generated by hbm2java
 */
@Entity
@Table(name = "abmc_sales_order_header")
public class AbmcSalesOrderHeader implements java.io.Serializable {
	...
	public AbmcSalesOrderHeader() {
	}

	public AbmcSalesOrderHeader(int transactionId, int targetId, String abmId, byte isNoPostBool,
			byte isMemorizedTransactionBool, byte isToBePrintedBool, byte isToBeSentBool, byte isSplitBool,
			byte isArapBool, byte isPaidBool, byte isSaleBool, byte isActiveBool, byte isAlwaysTrackBool,
	...
	public AbmcSalesOrderHeader(int transactionId, int targetId, Date transactionDate, Integer customerId, String abmId,
			String contactId, Integer salesTaxCodeId, String shipToId, Integer shipViaId, Integer salesRepId,
			Integer customStyleId, Integer customerMessageId, Integer termsId, Date latestLinkDate, Integer writeCount,
			Integer timestampTms, Integer modtimestampTms, Integer transNum, String docNum, String docNumNumericpart,
			Integer lastEditBy, byte isNoPostBool, byte isMemorizedTransactionBool, byte isToBePrintedBool,
			byte isToBeSentBool, byte isSplitBool, Short clearedType, byte isArapBool, byte isPaidBool, byte isSaleBool,
			byte isActiveBool, Date shipDate, String poNum, String fob, String other, byte isAlwaysTrackBool,
			Date dbCreatedTms, Date dbModifiedTms, Integer companyId, String memo, byte isAmtInclTaxBool,
