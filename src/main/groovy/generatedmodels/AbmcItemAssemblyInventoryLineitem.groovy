...
/**
 * AbmcItemAssemblyInventoryLineitem generated by hbm2java
 */
@Entity
@Table(name = "abmc_item_assembly_inventory_lineitem")
public class AbmcItemAssemblyInventoryLineitem implements java.io.Serializable {
	...
	public AbmcItemAssemblyInventoryLineitem() {
	}

	public AbmcItemAssemblyInventoryLineitem(int inventoryRecordId, int targetType, int targetId, String abmId,
	...
	public AbmcItemAssemblyInventoryLineitem(int inventoryRecordId, int targetType, int targetId,
