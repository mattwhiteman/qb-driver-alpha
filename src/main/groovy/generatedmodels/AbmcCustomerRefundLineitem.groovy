...
/**
 * AbmcCustomerRefundLineitem generated by hbm2java
 */
@Entity
@Table(name = "abmc_customer_refund_lineitem")
public class AbmcCustomerRefundLineitem implements java.io.Serializable {
	...
	public AbmcCustomerRefundLineitem() {
	}

	public AbmcCustomerRefundLineitem(int targetId, int transactionId, int paymentMethodId, byte isSourceBool,
			byte isNoPostBool, byte isMemorizedTransactionBool, byte isSplitBool, byte isArapBool, byte isDepositedBool,
			byte isPaidBool, String abmId, Date dbCreatedTms, Date dbModifiedTms, int companyId, double exchangeRate,
	...
	public AbmcCustomerRefundLineitem(int targetId, int transactionId, Date transactionDate, Short transactionViewType,
			Integer customerId, Integer vendorId, String contactId, Short transactionNameType, Short lineitemNameType,
			Short reimbursedType, Integer nextTargetId, Integer attributesId, Integer siblingAccountId,
			int paymentMethodId, Date latestLinkDate, Integer writeCount, Integer timestampTms, Integer modtimestampTms,
			Integer lastEditBy, byte isSourceBool, byte isNoPostBool, byte isMemorizedTransactionBool, byte isSplitBool,
			Short clearedType, byte isArapBool, byte isDepositedBool, byte isPaidBool, Integer accountId,
			BigDecimal openBalanceAmt, BigDecimal amountAmt, Date reconcileDate, String docNum,
			String docNumNumericpart, String abmId, Date dbCreatedTms, Date dbModifiedTms, String memo, int companyId,
			Integer arCreditCardPaymentId, Integer currencyId, double exchangeRate, BigDecimal foreignAmountAmt,
			byte isGainLossTargetBool, BigDecimal netOpenBalanceAmt, BigDecimal taxOpenBalanceAmt,
			BigDecimal grossOpenBalanceAmt, Integer arDebitCardPaymentId, Integer txnLineOrder) {
		this.targetId = targetId;
		this.transactionId = transactionId;
