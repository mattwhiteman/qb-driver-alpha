...
/**
 * AbmcBillHeader generated by hbm2java
 */
@Entity
@Table(name = "abmc_bill_header")
public class AbmcBillHeader implements java.io.Serializable {
	...
	private byte isItemReceiptBool;
	...
	public AbmcBillHeader() {
	}

	public AbmcBillHeader(int transactionId, int targetId, String abmId, byte isNoPostBool,
			byte isMemorizedTransactionBool, byte isSplitBool, byte isPaidBool, byte isPurchaseBool, byte isArapBool,
			byte isItemReceiptBool, byte isRefundedBool, byte isAlwaysTrackBool, Date dbCreatedTms, Date dbModifiedTms,
		...
		this.isItemReceiptBool = isItemReceiptBool;
	...
	public AbmcBillHeader(int transactionId, int targetId, Date transactionDate, Short transactionViewType,
			Integer vendorId, String abmId, String contactId, Integer termsId, Integer writeCount, Integer timestampTms,
			Integer modtimestampTms, Integer transNum, String docNum, String docNumNumericpart, Integer lastEditBy,
			Integer numItemTargets, byte isNoPostBool, byte isMemorizedTransactionBool, byte isSplitBool,
			byte isPaidBool, byte isPurchaseBool, byte isArapBool, byte isItemReceiptBool, byte isRefundedBool,
			Date dueDate, Date latestLinkDate, byte isAlwaysTrackBool, Date dbCreatedTms, Date dbModifiedTms,
	...
	@Column(name = "is_item_receipt_bool", nullable = false)
	public byte getIsItemReceiptBool() {
		return this.isItemReceiptBool;
	}

	public void setIsItemReceiptBool(byte isItemReceiptBool) {
		this.isItemReceiptBool = isItemReceiptBool;
	}
