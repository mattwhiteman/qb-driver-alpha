...
/**
 * AbmcStatementChargeInventoryLineitem generated by hbm2java
 */
@Entity
@Table(name = "abmc_statement_charge_inventory_lineitem")
public class AbmcStatementChargeInventoryLineitem implements java.io.Serializable {
	...
	public AbmcStatementChargeInventoryLineitem() {
	}

	public AbmcStatementChargeInventoryLineitem(int inventoryRecordId, int targetType, int targetId, String abmId,
	...
	public AbmcStatementChargeInventoryLineitem(int inventoryRecordId, int targetType, int targetId,
