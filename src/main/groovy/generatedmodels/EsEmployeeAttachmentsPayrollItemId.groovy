...
/**
 * EsEmployeeAttachmentsPayrollItemId generated by hbm2java
 */
@Embeddable
public class EsEmployeeAttachmentsPayrollItemId implements java.io.Serializable {

	private String employeeAbmId;
	private int position;

	public EsEmployeeAttachmentsPayrollItemId() {
	}

	public EsEmployeeAttachmentsPayrollItemId(String employeeAbmId, int position) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EsEmployeeAttachmentsPayrollItemId))
			return false;
		EsEmployeeAttachmentsPayrollItemId castOther = (EsEmployeeAttachmentsPayrollItemId) other;
