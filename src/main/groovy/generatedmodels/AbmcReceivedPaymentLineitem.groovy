...
/**
 * AbmcReceivedPaymentLineitem generated by hbm2java
 */
@Entity
@Table(name = "abmc_received_payment_lineitem")
public class AbmcReceivedPaymentLineitem implements java.io.Serializable {
	...
	public AbmcReceivedPaymentLineitem() {
	}

	public AbmcReceivedPaymentLineitem(int targetId, int transactionId, byte isSourceBool, byte isNoPostBool,
	...
	public AbmcReceivedPaymentLineitem(int targetId, int transactionId, Integer accountId, Date transactionDate,
			...
			Integer siblingAccountId, Integer paymentMethodId, Date latestLinkDate, Integer writeCount,
			Integer timestampTms, Integer modtimestampTms, Integer lastEditBy, byte isSourceBool, byte isNoPostBool,
			byte isMemorizedTransactionBool, byte isSplitBool, byte isPaidBool, Short clearedType, byte isArapBool,
			byte isDepositedBool, byte isDiscountBool, byte isUsesBilledDateBool, byte isAppliedDiscountBool,
			BigDecimal amountAmt, BigDecimal openBalanceAmt, String bankRefName, String bankRoutingNum,
			String bankAccountNum, Short bankAccountType, Date reconcileDate, Date dueDate, Date billedDate,
			String docNum, String docNumNumericpart, String abmId, Date dbCreatedTms, Date dbModifiedTms,
			Integer companyId, String memo, Integer arCreditCardPaymentId, Integer currencyId, double exchangeRate,
			BigDecimal foreignAmountAmt, byte isGainLossTargetBool, String epaymentTxnIdent, Short paymentEntryType,
			BigDecimal netOpenBalanceAmt, BigDecimal taxOpenBalanceAmt, BigDecimal grossOpenBalanceAmt,
			Integer arDebitCardPaymentId, Integer txnLineOrder, String merchantAccountNumber) {
		this.targetId = targetId;
		this.transactionId = transactionId;
