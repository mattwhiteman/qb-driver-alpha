...
/**
 * AbmcCustomerType generated by hbm2java
 */
@Entity
@Table(name = "abmc_customer_type")
public class AbmcCustomerType implements java.io.Serializable {
	...
	private String customerTypeAbmId;
	private Integer companyId;
	private int displayIndexNext;

	public AbmcCustomerType() {
	}

	public AbmcCustomerType(int customerTypeId, Date dbCreatedTms, Date dbModifiedTms, byte isHiddenBool,
	...
	public AbmcCustomerType(int customerTypeId, Date dbCreatedTms, Date dbModifiedTms, Integer timestampTms,
			Integer modtimestampTms, String name, byte isHiddenBool, byte isDeletedBool, byte isDeletePendingBool,
			Integer parentId, Short sublevel, String customerTypeAbmId, Integer companyId, int displayIndexNext) {
		this.customerTypeId = customerTypeId;
		this.dbCreatedTms = dbCreatedTms;
		this.dbModifiedTms = dbModifiedTms;
		...
		this.customerTypeAbmId = customerTypeAbmId;
	...
	@Column(name = "customer_type_abm_id", length = 17)
	public String getCustomerTypeAbmId() {
		return this.customerTypeAbmId;
	}

	public void setCustomerTypeAbmId(String customerTypeAbmId) {
		this.customerTypeAbmId = customerTypeAbmId;
	}
