...
/**
 * AbmcCheckInventoryLineitem generated by hbm2java
 */
@Entity
@Table(name = "abmc_check_inventory_lineitem")
public class AbmcCheckInventoryLineitem implements java.io.Serializable {
	...
	public AbmcCheckInventoryLineitem() {
	}

	public AbmcCheckInventoryLineitem(int inventoryRecordId, int targetType, int targetId, String abmId,
	...
	public AbmcCheckInventoryLineitem(int inventoryRecordId, int targetType, int targetId,
