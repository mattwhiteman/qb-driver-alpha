...
/**
 * AbmcCreditMemoHeader generated by hbm2java
 */
@Entity
@Table(name = "abmc_credit_memo_header")
public class AbmcCreditMemoHeader implements java.io.Serializable {
	...
	public AbmcCreditMemoHeader() {
	}

	public AbmcCreditMemoHeader(int transactionId, int targetId, String abmId, byte isNoPostBool,
			byte isMemorizedTransactionBool, byte isToBePrintedBool, byte isToBeSentBool, byte isSplitBool,
			byte isArapBool, byte isPaidBool, byte isOldTranTaxBool, byte isSaleBool, byte isAlwaysTrackBool,
	...
	public AbmcCreditMemoHeader(int transactionId, int targetId, Date transactionDate, Integer customerId, String abmId,
			String contactId, Integer termsId, Integer salesTaxCodeId, String shipToId, Integer shipViaId,
			Integer salesRepId, Integer customStyleId, Date latestLinkDate, Integer writeCount, Integer timestampTms,
			Integer modtimestampTms, Integer transNum, String docNum, String docNumNumericpart, Integer lastEditBy,
			byte isNoPostBool, byte isMemorizedTransactionBool, byte isToBePrintedBool, byte isToBeSentBool,
			byte isSplitBool, Short clearedType, byte isArapBool, byte isPaidBool, byte isOldTranTaxBool,
			byte isSaleBool, Integer customerMessageId, Date shipDate, Date deliveryDate, Date dueDate, String fob,
			String poNum, String other, byte isAlwaysTrackBool, Date dbCreatedTms, Date dbModifiedTms,
			...
			Integer siteId, String stickyNote, Integer transactionSendformsId) {
		this.transactionId = transactionId;
		this.targetId = targetId;
