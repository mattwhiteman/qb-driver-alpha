...
/**
 * AbmcTransferHeader generated by hbm2java
 */
@Entity
@Table(name = "abmc_transfer_header")
public class AbmcTransferHeader implements java.io.Serializable {
	...
	public AbmcTransferHeader() {
	}

	public AbmcTransferHeader(int transactionId, int targetId, String abmId, byte isArapBool, byte isTransmitMemoBool,
			byte isNoPostBool, byte isMemorizedTransactionBool, byte isAlwaysTrackBool, Date dbCreatedTms,
			Date dbModifiedTms, short lastAuditableAction, byte isSdkAppBool, double exchangeRate,
	...
	public AbmcTransferHeader(int transactionId, int targetId, Date transactionDate, String abmId, Integer customerId,
			Integer vendorId, Integer employeeId, Integer otherId, Short transactionNameType, Integer writeCount,
			Integer timestampTms, Integer modtimestampTms, Integer transNum, String docNum, String docNumNumericpart,
			Integer lastEditBy, byte isArapBool, Short onlineStateType, byte isTransmitMemoBool, byte isNoPostBool,
