...
/**
 * AbmcCreditMemoInventoryLineitem generated by hbm2java
 */
@Entity
@Table(name = "abmc_credit_memo_inventory_lineitem")
public class AbmcCreditMemoInventoryLineitem implements java.io.Serializable {
	...
	public AbmcCreditMemoInventoryLineitem() {
	}

	public AbmcCreditMemoInventoryLineitem(int inventoryRecordId, int targetType, int targetId, String abmId,
	...
	public AbmcCreditMemoInventoryLineitem(int inventoryRecordId, int targetType, int targetId,
