...
/**
 * AbmcBillLineitem generated by hbm2java
 */
@Entity
@Table(name = "abmc_bill_lineitem")
public class AbmcBillLineitem implements java.io.Serializable {
	...
	private byte includeInBox4Bool;
	private String manufacturerPartNum;

	public AbmcBillLineitem() {
	}

	public AbmcBillLineitem(int targetId, int transactionId, byte isSourceBool, byte isNoPostBool,
			byte isMemorizedTransactionBool, byte isGroupendRowBool, byte isAppliedDiscountBool,
			byte isBasedOnTimeActBool, byte isReceiptBool, byte isArapBool, byte isSplitBool, byte isPaidBool,
			byte isPurchaseBool, byte isDepositedBool, byte isDiscountBool, byte isInvoicedBool,
			byte isManuallyClosedBool, byte isReceivedBool, String abmId, Date dbCreatedTms, Date dbModifiedTms,
			byte isTransTaxBool, double exchangeRate, byte isGainLossTargetBool, byte includeInBox4Bool) {
		...
		this.includeInBox4Bool = includeInBox4Bool;
	}

	public AbmcBillLineitem(int targetId, int transactionId, Integer accountId, Date transactionDate,
			...
			byte isGroupendRowBool, byte isAppliedDiscountBool, byte isBasedOnTimeActBool, byte isReceiptBool,
			byte isArapBool, byte isSplitBool, byte isPaidBool, byte isPurchaseBool, Short clearedType,
			byte isDepositedBool, Short transactionNameType, Short lineitemNameType, BigDecimal quantityQnty,
			Short reimbursedType, byte isDiscountBool, byte isInvoicedBool, Date reconcileDate, Date dueDate,
			BigDecimal cogsAmt, BigDecimal openQnty, BigDecimal openBalanceAmt, BigDecimal unitPriceAmt,
			BigDecimal unitPricePct, BigDecimal unitPriceQnty, byte isManuallyClosedBool, byte isReceivedBool,
			...
			byte includeInBox4Bool, String manufacturerPartNum) {
		this.targetId = targetId;
		this.transactionId = transactionId;
	...
	@Column(name = "include_in_box4_bool", nullable = false)
	public byte getIncludeInBox4Bool() {
		return this.includeInBox4Bool;
	}

	public void setIncludeInBox4Bool(byte includeInBox4Bool) {
		this.includeInBox4Bool = includeInBox4Bool;
	}
