...
/**
 * AbmcBillInventoryLineitem generated by hbm2java
 */
@Entity
@Table(name = "abmc_bill_inventory_lineitem")
public class AbmcBillInventoryLineitem implements java.io.Serializable {
	...
	public AbmcBillInventoryLineitem() {
	}

	public AbmcBillInventoryLineitem(int inventoryRecordId, int targetType, int targetId, String abmId,
	...
	public AbmcBillInventoryLineitem(int inventoryRecordId, int targetType, int targetId, Integer purchaseTransactionId,
			Integer purchaseTargetId, Short purchaseTransactionViewType, Date purchaseTransactionDate,
			Integer accountId, BigDecimal amountAmt, BigDecimal quantityQnty, String abmId, Date dbCreatedTms,
			Date dbModifiedTms, Integer companyId, BigDecimal foreignAmountAmt) {
		this.inventoryRecordId = inventoryRecordId;
		this.targetType = targetType;
		this.targetId = targetId;
